...
class ELLogsViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.section == 0 {
            ...
            else
           {
            ...
            if indexPath.row == 2 {
                cell.CustomLabel.text = logvalue.ter//String(indexPath.section)
            }
            if indexPath.row == 3 {
            ...
            if indexPath.row == 4 {
                ...
                cell.CustomLabel.text = "Content123"
            }
    ...
    */
    ...
    func readValues(){
        ...
        let queryString = "SELECT * FROM tblLogs"
        ...
        while(sqlite3_step(stmt) == SQLITE_ROW){
            ...
            let badgeNo = String(cString: sqlite3_column_text(stmt, 2))
            let ter = String(cString: sqlite3_column_text(stmt, 3))
            let direction = String(cString: sqlite3_column_text(stmt, 4))
            
            
            //adding values to list
            log.append(logs( id: Int(id),date: String(describing: date), badgeNo: String(describing: badgeNo),ter: String(describing: ter),direction: String(describing: direction)))
